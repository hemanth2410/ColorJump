...
public class SimpleSpectrum : MonoBehaviour {
    ...
    [SerializeField] bool useCustomOutput = true;
    public static float[] SpectrumResult;
...
#region COLOR PROPERTIES
    ...
    public void RebuildSpectrum()
    {
        ...
        SpectrumResult = new float[numSamples];
    ...
    public static void returnSpectrum()
    {
        SSWebInteract.GetSpectrumData(SpectrumResult);
    }
